...
public class TickerPriceChangeStatistics {
    @JsonProperty("symbol")
    ...
    public TickerPriceChangeStatistics(){}

    public TickerPriceChangeStatistics(String symbol, String priceChange, String priceChangePercent,
